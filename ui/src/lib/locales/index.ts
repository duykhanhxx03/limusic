...
export type LocaleId = 'en' | 'es' | 'fr' | 'tr' | 'pt-BR' | 'id' | 'ro' | 'vi';
...
export const translations: Record<LocaleId, DeepPartial<Translations>> = { en, es, fr, tr, 'pt-BR': ptBR, id, ro, vi };
